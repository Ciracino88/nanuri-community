...
function HomeCreature({ active, mousePos, blink, color }: CreatureProps) {
  ...
  return (
    <svg ref={ref} viewBox="0 0 40 40" width="40" height="40" fill="none">
      ...
      <rect x="16" y="27" width="8" height="8" rx="1.5" fill="#1a1a2e" />
...
function ScheduleCreature({ active, mousePos, blink, color }: CreatureProps) {
  ...
  return (
    <svg ref={ref} viewBox="0 0 40 40" width="40" height="40" fill="none">
      ...
      <rect x="12" y="5" width="4" height="8" rx="2" fill={active ? "#fff" : "#718096"} opacity="0.8" />
      <rect x="24" y="5" width="4" height="8" rx="2" fill={active ? "#fff" : "#718096"} opacity="0.8" />
      <circle cx="13" cy="26" r="5" fill="#1a1a2e" />
      <Eye cx={13} cy={26} r={4} pupilR={2} mousePos={mousePos} svgRef={ref} blink={blink} color={color} />
      <circle cx="27" cy="26" r="5" fill="#1a1a2e" />
...
function GalleryCreature({ active, mousePos, blink, color }: CreatureProps) {
  ...
  return (
    <svg ref={ref} viewBox="0 0 40 40" width="40" height="40" fill="none">
      ...
      <rect x="7" y="9" width="26" height="22" rx="2" fill="#1a1a2e" />
